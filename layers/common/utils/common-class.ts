...
import { IgnoredThrown, NavigateThrown, DataThrown, NotifyThrown, NoticeThrown, type NotifyThrownBase } from '../classes/ClassThrown';
...
export function newNoticeThrown<T extends I18nNotice = I18nNotice>(...notices: T[]) {
